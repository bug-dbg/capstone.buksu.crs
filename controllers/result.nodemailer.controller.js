    ...
    sendEmail: async (req, res) => {
        ...
        try {
            ...
            let courses = [
                ...
                {name: "Bachelor of Law (Juris Doctor)", description: "This course requires law school applicants to have a bachelor's degree as it is a professional doctorate degree used in jurisdictions where the basic law degree is a graduate-level degree. This program involves the study of general principles and basic theories of law as an intellectual endeavor, as well as a systematic and analytical evaluation of specific codes and statutory provisions of the act."},
            ]
