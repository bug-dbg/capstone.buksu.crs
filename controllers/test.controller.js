...
const testCtrl = {
  ...
  evaluate: async (req, res, next) => {
    ...
    try {
      ...
      // map the scaled value to the answer
      let scaled = value.map((a) => {
        return {
          category: a.category,
          answer: a.value,
          scoreRange: getScoreRange(a.value)
        };
      });

      let answerpercategory = scaled.reduce((acc, cur) => {
        acc[cur.category] = acc[cur.category] || [];
        acc[cur.category].push(cur.scoreRange);
        return acc;
      }, {});



      let average = Object.keys(answerpercategory).reduce((acc, cur) => {
        acc[cur] = answerpercategory[cur].reduce((a, c) => a + c) / answerpercategory[cur].length
        return acc;
      }, {});

      // push average to an array
      for (let category in average) {
        averageArr.push(average[category])
      }
      ...
      if (value) {
        ...
        let courses = [
          ...
          { name: "Bachelor of Science in Mathematics", description: "A Bachelor's degree in Mathematics is a bachelor's degree that teaches theory and training in practical and core mathematics. BS in Mathematics provides a broad understanding of mathematical topics with depth in specific areas, as well as research into the outcomes of analytical, qualitative and logical reasoning. Mathematics is an incredibly diverse degree that can provide with numerous opportunities.", category: "MATH" },
          ...
          { name: "Bachelor of Science in Accountancy", description: "The Accountancy program is designed to produce graduates who are professionally competent to assume responsible practice of Public Accounting and to render accounting, management, auditing, and tax advisory services. It also aims to prepare graduate to assume key positions in the accounting and administrative departments of private and public firms, and finally to equip the graduates with the latest knowledge and techniques in accounting to keep abreast with the needs of business and industry.", category: "MATH" },
        ...
        // Sort the top three result of the recommendation
        // const courseResult = courses.sort((a, b) => b.ratings - a.ratings).slice(0, 3)
        ...
        //   { course: "Bachelor of Science in Biology Major in Biotechnology", average: [71,45,74,54,38,50,62] },
        //   { course: "Bachelor of Science in Environmental Science Major in Environmental Heritage Studies", average: [71,45,74,54,38,50,62] },
        //   { course: "Bachelor of Arts in English Language", average: [36, 35, 72, 68, 24, 96, 47] },
        //   { course: "Bachelor of Arts in Economics", average: [78, 63, 96, 96, 84, 88, 87] },
        //   { course: "Bachelor of Arts in Sociology", average: [64, 70, 94, 88, 69, 91, 90] },
        //   { course: "Bachelor of Arts in Philosophy", average: [74, 81, 88, 90, 61, 83, 70] },
        //   { course: "Bachelor of Arts in Social Sciences", average: [65, 66, 94, 86, 70, 90, 87] },
        //   { course: "Bachelor of Science in Mathematics", average: [83, 63, 80, 92, 78, 80, 80] },
        //   { course: "Bachelor of Science in Community Development", average: [71, 48, 86, 68, 73, 75, 80] },
        //   { course: "Bachelor of Science in Development Communication", average: [72, 76, 100, 88, 66, 100, 90] },
        //   { course: "Bachelor of Public Administration Major in Local Governance", average: [20, 20, 68, 46, 32, 38, 30] },
        //   { course: "Bachelor of Science in Nursing", average: [74, 66, 76, 80, 80, 80, 80] },
        //   { course: "Bachelor of Science in Accountancy", average: [68, 86, 92, 100, 100, 100, 100] },
        //   { course: "Bachelor of Science in Business Administration Major in Financial Management", average: [68, 86, 92, 100, 100, 100, 100] },
        //   { course: "Bachelor of Science in Hospitality Management", average: [77, 86, 92, 100, 100, 100, 100] },
        //   { course: "Bachelor of Science in Automotive Technology", average: [55, 48, 72, 52, 49, 30, 32] },
        //   { course: "Bachelor of Science in Electronics Technology", average: [81, 78, 88, 94, 60, 68, 70] },
        //   { course: "Bachelor of Science in Food Technology", average: [64, 43, 68, 88, 73, 80, 55] },
        //   { course: "Bachelor of Science in Information Technology", average: [69, 31, 88, 78, 49, 41, 32] },
        //   { course: "Bachelor of Science in Entertainment and Multimedia Computing major in Digital Animation Technology Game Development", average: [71, 40, 88, 74, 49, 58, 37] },
        //   { course: "Bachelor of Elementary Education", average: [64, 71, 94, 70, 73, 91, 92] },
        //   { course: "Bachelor of Secondary Education Major in Mathematics", average: [83, 63, 80, 92, 78, 80, 80] },
        //   { course: "Bachelor of Secondary Education Major in Filipino", average: [64, 71, 94, 70, 73, 91, 92] },
        //   { course: "Bachelor of Secondary Education Major in English", average: [36, 35, 72, 68, 24, 96, 47] },
        //   { course: "Bachelor of Secondary Education Major in Social Studies", average: [64, 71, 94, 70, 73, 91, 92] },
        //   { course: "Bachelor of Secondary Education Major in Science", average: [64, 71, 94, 70, 73, 91, 92] },
        //   { course: "Bachelor of Early Childhood Education", average: [64, 71, 94, 70, 73, 91, 92] },
        //   { course: "Bachelor of Physical Education", average: [63, 86, 96, 70, 73, 93, 92] },

        // ]
      
      //// get the average of the top 3 courses per category
      ...
      //   console.log("Average: " + columnAverages);
        ...
        // const coursesArray = Array.from(coursesUnderRecommendedCategory);
        const courseNames = coursesUnderRecommendedCategory.map(course => course.name);
        ...
        return res.render('result_page/result', { category: recommendedCategory, prediction: coursesUnderRecommendedCategory });
